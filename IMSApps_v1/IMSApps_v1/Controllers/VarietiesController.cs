...
namespace IMSApps_v1.Controllers
{
    ...
    public class VarietiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,SizeId,ColorId,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate")] Variety variety)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,SizeId,ColorId,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate")] Variety variety)
        {
            if (ModelState.IsValid)
            {
