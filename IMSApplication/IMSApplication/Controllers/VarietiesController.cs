...
namespace IMSApplication.Controllers
{
    public class VarietiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,SizeId,ColorId,Quantity,Status,CreatedBy,Created,ModifiedBy,Modified")] Variety variety)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,SizeId,ColorId,Quantity,Status,CreatedBy,Created,ModifiedBy,Modified")] Variety variety)
        {
            if (ModelState.IsValid)
            {
